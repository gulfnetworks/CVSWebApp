...
namespace CVSWebApp.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,CompanyName,CompanyAddress,CompanyContact,CompanyLogoUrl,CompanyCode,CreatedDate,ExpiryDate,CountryId,TimeZone")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,CompanyName,CompanyAddress,CompanyContact,CompanyLogoUrl,CompanyCode,CreatedDate,ExpiryDate,CountryId,TimeZone")] Company company)
        {
