    ...
    public partial class Migration1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResolutionLog", x => x.ResolutionLogId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Survey_Outlets_OutletId",
                        column: x => x.OutletId,
                        principalTable: "Outlets",
                        principalColumn: "OutletId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Survey_AspNetUsers_StaffId",
                        column: x => x.StaffId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Survey_ManagerId",
                table: "Survey",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_Survey_OutletId",
                table: "Survey",
                column: "OutletId");

            migrationBuilder.CreateIndex(
                name: "IX_Survey_StaffId",
                table: "Survey",
                column: "StaffId");
        }
